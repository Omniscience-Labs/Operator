MODEL_ACCESS_TIERS = {
    "free": [
        ...
        # "bedrock/us.anthropic.claude-3-5-sonnet-20240620-v1:0",  # Omni 4 - AWS Bedrock (Alternative)
    ],
    "tier_2_40": [
        # "openrouter/deepseek/deepseek-chat",
...
MODEL_NAME_ALIASES = {
    ...
    "Omni 4": "anthropic/claude-3-5-sonnet-latest",  # Omni 4 - Direct Anthropic API (Recommended)
    "Omni 5": "bedrock/us.anthropic.claude-sonnet-4-20250514-v1:0",  # Omni 5 - AWS Bedrock
    ...
    "anthropic/claude-3-5-sonnet-latest": "anthropic/claude-3-5-sonnet-latest",  # Omni 4 - Direct Anthropic API
    "bedrock/us.anthropic.claude-sonnet-4-20250514-v1:0": "bedrock/us.anthropic.claude-sonnet-4-20250514-v1:0",  # Omni 5 - AWS Bedrock
