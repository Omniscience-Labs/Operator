    ...
    const renderDocument = async () => {
      ...
      try {
        ...
        const options: DocxPreviewOptions = {
          ...
          inWrapper: true, // Try with wrapper for headers
          ignoreWidth: false,
          ignoreHeight: false,
          ignoreFonts: false,
          breakPages: true,
          ignoreLastRenderedPageBreak: false, // Don't ignore page breaks for headers
          experimental: true, // Enable experimental features for better header support
          useBase64URL: false,
