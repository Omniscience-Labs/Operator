            ...
            >
                <DialogHeader>
                    ...
                    <p className="text-sm text-muted-foreground">
                        For advanced users: If your chosen model isn't supported by LiteLLM, please <a href="mailto:support@omni.ai?subject=Custom%20Model%20Support" className="text-blue-500 hover:text-blue-600 underline">contact our support team</a> for assistance with custom model integration.
                    </p>
                </DialogHeader>
