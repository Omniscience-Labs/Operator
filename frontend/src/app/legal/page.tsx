                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE OPERATOR
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        "Site" refers to the Operator website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Operator website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@omni.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@omni.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@omni.ai. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Operator logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE OPERATOR WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      OPERATOR DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Operator in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Operator does not collect biometric or identifying
